        ...
        <>
            <nav>
                <ul>
                    ...
                    >
                        <a href="https://www.linkedin.com/in/david-friedrich-558140b/" title="LinkedIn" target="_blank" rel="noopener noreferrer"><FontAwesomeIcon icon="fa-brands fa-linkedin" /></a>
                    </li>
                    <li
                        className="sunken tooltip --horizontal"
                        data-tooltip="Github"
                    >
                        <a href="https://github.com/thefeddy/" title="GitHub" target="_blank" rel="noopener noreferrer"><FontAwesomeIcon icon="fa-brands fa-github" /></a>
                    </li>
                    <li
                        className="sunken tooltip --horizontal"
                        data-tooltip="Resume Repo"
                    >
                        <a href="https://github.com/thefeddy/resume" title="Source Code" target="_blank" rel="noopener noreferrer"><FontAwesomeIcon icon="fa-duotone fa-solid fa-code" /></a>
                    </li>
                    <li
                        className="sunken tooltip --horizontal"
                        data-tooltip="Resume">
                        <a href="/resume/David_Friedrich_Senior_UI_Engineer_Resume.pdf" title="Resume" target="_blank"><FontAwesomeIcon icon="fa-light fa-file-user" /></a>
                    </li>
                </ul>
            </nav>
